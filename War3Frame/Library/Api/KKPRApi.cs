...
public class KKApi
{
    ...
    private static readonly IntPtr _dzFrameSetModelEnableWideScreenPtr =
        War3.GetNativeFunction("DzFrameSetModelEnableWideScreen");
    ...
    private static readonly IntPtr _dzGetUnitAbilityIsDisabledPtr =
        War3.GetNativeFunction("DzGetUnitAbilityIsDisabled");

    private static readonly IntPtr _dzGetUnitAbilityDisabledCountPtr =
        War3.GetNativeFunction("DzGetUnitAbilityDisabledCount");
    ...
    private static readonly IntPtr _dzSetUnitAbilityTechReachTipPtr =
        War3.GetNativeFunction("DzSetUnitAbilityTechReachTip");

    private static readonly IntPtr _dzAsyncGetCurrentBuildingAbilityIdPtr =
        War3.GetNativeFunction("DzAsyncGetCurrentBuildingAbilityId");

    private static readonly IntPtr _dzAsyncGetCurrentBuildingUnitIdPtr =
        War3.GetNativeFunction("DzAsyncGetCurrentBuildingUnitId");

    private static readonly IntPtr _dzFrameUnlockMouseRectLimitPtr =
        War3.GetNativeFunction("DzFrameUnlockMouseRectLimit");
    ...
    {
        return DzPositionCanPlaceAround(JassApi.GetLocationX(loc), JassApi.GetLocationY(loc), collision_size,
            collision_type);
    }
