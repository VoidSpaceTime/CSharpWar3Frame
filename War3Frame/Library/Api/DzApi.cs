...
public static class DzApi
{
    ...
    private static readonly IntPtr _dzTriggerRegisterMouseEventPtr =
        War3.GetNativeFunction("DzTriggerRegisterMouseEvent");

    private static readonly IntPtr _dzTriggerRegisterMouseEventByCodePtr =
        War3.GetNativeFunction("DzTriggerRegisterMouseEventByCode");

    private static readonly IntPtr _dzTriggerRegisterKeyEventPtr = War3.GetNativeFunction("DzTriggerRegisterKeyEvent");

    private static readonly IntPtr _dzTriggerRegisterKeyEventByCodePtr =
        War3.GetNativeFunction("DzTriggerRegisterKeyEventByCode");

    private static readonly IntPtr _dzTriggerRegisterMouseWheelEventPtr =
        War3.GetNativeFunction("DzTriggerRegisterMouseWheelEvent");

    private static readonly IntPtr _dzTriggerRegisterMouseWheelEventByCodePtr =
        War3.GetNativeFunction("DzTriggerRegisterMouseWheelEventByCode");

    private static readonly IntPtr _dzTriggerRegisterMouseMoveEventPtr =
        War3.GetNativeFunction("DzTriggerRegisterMouseMoveEvent");

    private static readonly IntPtr _dzTriggerRegisterMouseMoveEventByCodePtr =
        War3.GetNativeFunction("DzTriggerRegisterMouseMoveEventByCode");
    ...
    private static readonly IntPtr _dzTriggerRegisterWindowResizeEventPtr =
        War3.GetNativeFunction("DzTriggerRegisterWindowResizeEvent");

    private static readonly IntPtr _dzTriggerRegisterWindowResizeEventByCodePtr =
        War3.GetNativeFunction("DzTriggerRegisterWindowResizeEventByCode");
    ...
    private static readonly IntPtr _dzFrameGetCommandBarButtonPtr =
        War3.GetNativeFunction("DzFrameGetCommandBarButton");
    ...
    private static readonly IntPtr _dzFrameGetUpperButtonBarButtonPtr =
        War3.GetNativeFunction("DzFrameGetUpperButtonBarButton");
    ...
    private static readonly IntPtr _dzFrameSetUpdateCallbackByCodePtr =
        War3.GetNativeFunction("DzFrameSetUpdateCallbackByCode");
    ...
    private static readonly IntPtr _dzFrameSetScriptByCodeAsyncPtr =
        War3.GetNativeFunction("DzFrameSetScriptByCodeAsync");

    private static readonly IntPtr _dzFrameSetScriptBlockAsyncPtr =
        War3.GetNativeFunction("DzFrameSetScriptBlockAsync");
    ...
    private static readonly IntPtr _dzSimpleFontStringFindByNamePtr =
        War3.GetNativeFunction("DzSimpleFontStringFindByName");
    ...
    private static readonly IntPtr _dzOriginalUIAutoResetPointPtr =
        War3.GetNativeFunction("DzOriginalUIAutoResetPoint");
    ...
    private static readonly IntPtr _dzGetConvertWorldPositionXPtr =
        War3.GetNativeFunction("DzGetConvertWorldPositionX");

    private static readonly IntPtr _dzGetConvertWorldPositionYPtr =
        War3.GetNativeFunction("DzGetConvertWorldPositionY");
    ...
    public static void DzTriggerRegisterMouseEventByCode(JTrigger trig, int btn, int status, bool sync,
        Action funcHandle)
    {
