...
public struct ProjectileRuntimeState : IComponent
{
    ...
    public System.Numerics.Vector3 controlPoint1;
    public System.Numerics.Vector3 controlPoint2;
...
///   ProjectileLinearData = 方向弹道（朝一个方向飞，沿途伤害）
/// </summary>
public struct ProjectileLinearData : IComponent
{
