...
public static partial class Bootstrap
{
    ...
    public static void Main(bool isAot)
    {
        ...
        QueryStructuralSafetyScenario.Initialize(JassApi.Player(0));
        UnitLifecycleValidationScenario.Initialize(JassApi.Player(0));
        TriggerCooldownValidationScenario.Initialize(JassApi.Player(0));
